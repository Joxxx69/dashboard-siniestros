...
export const DEFAULT_LAYOUTS: Layouts = {
  lg: [
    ...
    { i: 'by-status', x: 4, y: 6, w: 4, h: 6, minW: 3, minH: 4 },
    { i: 'impact', x: 8, y: 6, w: 4, h: 6, minW: 3, minH: 4 },
  ],
  md: [
    ...
    { i: 'by-status', x: 0, y: 12, w: 4, h: 6 },
    { i: 'impact', x: 4, y: 12, w: 4, h: 6 },
  ],
  sm: [
    { i: 'by-province', x: 0, y: 0, w: 4, h: 6 },
    ...
    { i: 'by-status', x: 0, y: 24, w: 4, h: 6 },
    { i: 'impact', x: 0, y: 30, w: 4, h: 6 },
  ],
}
...
export const useLayoutStore = create<LayoutStore>()(
  persist(
    ...
    { name: 'siniestros-dashboard-layout' }
  )
)
